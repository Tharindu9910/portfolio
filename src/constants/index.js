...
export const PROJECTS = [
    {
      ...
      tagline: 'A cloud-native microservices platform bridging consumers and businesses through AI-powered personalization, real-time promotions, and multi-channel engagement — built for scale with a secure, enterprise-grade backend',
      ...
      techinical_decisions: {
        body: [
          ...
          `Three node types: (:User), (:Business), and (:Promotion).`,
          `Three relationships: FOLLOWS, LOCKED, and POSTED.`,
  ...
  
    {
      ...
      tagline: 'A drop-in conversational AI widget for any website — voice, text, and real-time chat in one script tag.',
      role: 'Full Stack Engineer',
  ...
  
    {
      ...
      tagline: "Low-latency, encrypted, production-grade chat infrastructure built on MQTT and Google Cloud.",
      ...
      challenges: [
        ...
        {
          num: '03',
          title: "High-Availability Broker Deployment",
          body: "Configuring Mosquitto on Google Compute Engine for high availability required careful infrastructure planning — ensuring the broker could handle reconnections, maintain persistent sessions, and recover from instance-level failures without message loss, all while keeping connection latency low for mobile clients."
        }
      ],
      challengeImage: {
        src: "",
      ...
      metrics: [
        {
          ...
          value: "<100ms",
          description: "End-to-end message delivery latency measured in production across mobile clients."
        },
        {
          label: "Encryption Standard",
          value: "ECC + AES",
          description: "Hybrid end-to-end encryption applied to all message payloads — zero plaintext transmission."
        },
        {
          label: "Transport Security",
          value: "TLS 8883",
          description: "All broker connections secured via MQTT over TLS on port 8883."
        },
      ]
    },
    {
      ...
      tagline: "Real-time face recognition-driven attendance tracking with rule-based logic for 11 attendance scenarios",
      ...
      architecture: {
        body: [
          ...
          "The backend exposes 45+ async REST API endpoints organized around core domain entities: teachers, students, courses, groups, lecture halls, schedules, attendance, simulation, and reports. All endpoints use async def with await, allowing the server to handle concurrent requests without thread contention.",
          ...
          "The Next.js frontend (App Router) communicates with the backend via REST, rendering 10 pages including a real-time attendance dashboard, a simulation module for hardware-free testing, and a comprehensive reports page with PDF/Excel export capabilities.",
        ]
      },
      ...
      techinical_decisions: {
        body: [
          ...
          "Simulation module as a first-class feature: Rather than mocking data in tests, a dedicated simulation endpoint and frontend page were built to create attendance events without camera hardware. This enabled full end-to-end scenario testing during the POC phase and made stakeholder demonstrations straightforward.",
      ...
      challenges: [
        ...
        {
          num: '03',
          title: "Proving the System Without Camera Hardware",
          body: "As a POC, physical camera infrastructure wasn't available for most of the development cycle. Stakeholder demos and scenario testing needed to work regardless. Building the simulation module as a proper feature — with its own API endpoints, frontend UI, and event history log — meant all 11 scenarios could be demonstrated end-to-end without any hardware dependency."
        },
      ],
      challengeImage: {
      ...
      metrics: [
        {
          ...
          value: "~50%",
          description: "Measured before and after adding compound MongoDB indexes on student ID, course code, and date fields"
        },
        {
          label: "Attendance Scenarios",
          value: "11",
          description: "Distinct scenarios handled by the rule-based logic engine including late arrivals, early exits, unauthorized access, and back-to-back lectures"
        },
        {
          label: "API Endpoints",
          value: "45+",
          description: "Async REST endpoints covering all domain entities — teachers, students, courses, halls, schedules, attendance, simulation, and reports"
        },
        {
          label: "Frontend Pages",
          value: "10",
          description: "Next.js App Router pages including real-time dashboard, simulation module, and comprehensive analytics reports"
        },
